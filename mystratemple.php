...
if (isset ($_GET['temp']) && $_GET['temp'] == 'modlitwa') {
	...
	if ($rzut <= $pw1) {
	    ...
	    if ($player -> deity == 'Lolth') {
	        $arrtemp = array(0,1,2,3,4,5,6,8,9,13,14,15);
	        $amount = 12;
	    }
...
$smarty -> display('mystratemple.tpl');
