...
$title = "Swiatynia Ksiezycowej Panny";
...
if (isset ($_GET['temp']) && $_GET['temp'] == 'modlitwa') {
	...
	if ($rzut <= $pw1) {
            ...
            $arrtemple = $player -> GetArray($arrtemp);
	    if ($player -> deity == 'Bane') {
	        $arrtemp = array(0,1,2,3,4,6,7,8,9,11,16,17);
	        $amount = 12;
	    }
...
$smarty -> display('selunetemple.tpl');
