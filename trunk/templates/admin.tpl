...
<li><A href="admin.php?view=clearw">Usunac Wiesc</a>
<li><A href="addnews.php">Dodac Plotke</a>
<li><A href="admin.php?view=clearp">Usunac Plotke</a>
<li><a href="admin.php?view=qmsg">Dodac szybka wiadomosc</a>
<br>*********************
<li><a href="admin.php?view=del">Skasowac uzytkownika</a>
<li><a href="admin.php?view=donate">Dotowac uzytkownika</a>
<li><a href="admin.php?view=takeaway">Zabrac sztuki zlota</a>
<li><a href="admin.php?view=add">Zmienic range</a>
<li><a href="rank.php">Panel rang</a>
<li><a href="city.php">Panel miast</a>
<li><a href="old.php">Panel niektywnych u¿ytkowników</a>
<br>*********************
<li><a href="admin.php?view=editrasa">Zmienic rase</a>
<li><a href="admin.php?view=editklasa">Zmienic klase</a>
<li><a href="admin.php?view=dajap">Daj AP</a>
<li><a href="admin.php?view=delap">Zabierz AP</a>
<li><a href="admin.php?view=zabij">Zabij bogiem</a>
<br>*********************
<li><a href="admin.php?view=dajbank">Daj Pieniadze do Banku</a>
<li><a href="admin.php?view=delbank">Zabierz Pieniadze z Banku</a>
<li><a href="admin.php?view=dajene">Daj Energie</a>
<li><a href="admin.php?view=delene">Zabierz Energie</a>
<br>*********************
<li><a href="admin.php?view=tags">Dac Immunitet</a>
<li><a href="admin.php?view=tags1">Zabierz Immunitet</a>
<li><a href="admin.php?view=style">Zmiec Styl Gry</a>
<li><a href="admin.php?view=clearf">Wyczysc Forum</a>
<br>*********************
<li><a href="admin.php?view=clearc">Wyczysc Czat</a>
...
<br>*********************
<li><a href="admin.php?view=clearm">Wyczysc potwory</a>
<li><a href="admin.php?view=kowal">Kowal</a>
<li><a href="admin.php?view=czary">Czary</a>
<li><a href="admin.php?view=poczta">Wyslij poczte do wszystkich</a>
<br>*********************
<li><a href="admin.php?view=czat">Zablokuj/odblokuj wiadomosci od gracza na czacie</a>
<li><a href="admin.php?view=jail">Wyslij gracza do wiezienia</a>
<li><a href="admin.php?view=bridge">Dodaj pytanie na moscie
  smierci</a>
<li><a href="admin.php?view=mail">Wyslij maila do wszystkich graczy</a>	
<br>*********************
<li><a href="admin.php?view=close">Zablokuj/odblokuj gre</a>
<li><a href="admin.php?view=delplayers">Wykasuj nieaktywnych graczy</a>
<li><a href="admin.php?view=ban">Zbanuj gracza</a>
<li><a href="admin.php?view=pary">Pobaw sie w Ksiedza i daj slub</a>   
<br>*********************     
<li><a href="bugtrack.php">Bugtrack</a>
<li><a href="admin.php?view=dm">Daj Mithril</a>
<li><a href="admin.php?view=clearcl">Wyczysc Logi</a>
<li><a href="admin.php?view=clearcm">Wyczysc Poczte</a> 
<br>*********************
<li><a href="admin.php?view=poll">Dodaj sonde</a><br>
 <li><a href="admin1.php?view=jailbreak">Uwolnij gracza z lochow</a><br />
 <li><a href="mapprv.php" target="Podglad mapy" onclick="window.open('mapprv.php', 'Podglad mapy', 'menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=no,fullscreen=no,channelmode=no,width=550,height=550')">test</a>
    </ul>

{/if}
{if $View == "qmsg"}
	<form method="post" action="admin.php?view=qmsg&amp;step=add">
...
<form method="post" action="admin.php?view=altara&amp;step=add">
...
{/if}
{if $View == "pary"}
    <form method="post" action="admin.php?view=pary&step=add">
...
{if $View == "style"}
    <form method="post" action="admin.php?view=style&step=add">
...
{if $View == "editrasa"}
    <form method="post" action="admin.php?view=editrasa&step=editrasa">
...
{if $View == "editklasa"}
    <form method="post" action="admin.php?view=editklasa&step=editklasa">
...
{if $View == "tags1"}
    <form method="post" action="admin.php?view=tags1&step=tag1">
...
{if $View == "dajene"}
    <form method="post" action="admin.php?view=dajene&step=dajene">
    ID: <input type="text" name="id"> <br>
    ilos&aelig;: <input type="text" name="amount">
...
{if $View == "dajbank"}
    <form method="post" action="admin.php?view=dajbank&step=dajbank">
    ID: <input type="text" name="id"> <br>
...
{if $View == "dajap"}
    <form method="post" action="admin.php?view=dajap&step=dajap">
    ID: <input type="text" name="id"> <br>
    ilosc: <input type="text" name="amount">
    <input type="submit" value="Daj"></form>
{/if}
...
{if $View == "delene"}
    <form method="post" action="admin.php?view=delene&step=delene">
    ID: <input type="text" name="id"> <br>
    ilosc: <input type="text" name="taken">
    <input type="submit" value="Zabierz"></form>
{/if}
...
{if $View == "delbank"}
    <form method="post" action="admin.php?view=delbank&step=delbank">
    ID: <input type="text" name="id"> <br>
    ilosc: <input type="text" name="taken">
    <input type="submit" value="Zabierz"></form>
{/if}
...
{if $View == "delap"}
    <form method="post" action="admin.php?view=delap&step=delap">
    ID: <input type="text" name="id"> <br>
    ilosc: <input type="text" name="taken">
    <input type="submit" value="Zabierz"></form>
{/if}
...
{if $View == "close"}
    <form method="post" action="admin.php?view=close&step=close">
...
{if $View == "dm"}
    <form method="post" action="admin.php?view=dm&step=donated">
    ID: <input type="text" name="id"> <br>
    ilosc: <input type="text" name="amount">
...
{if $View == "poll"}
    ...
    Ile opcji bï¿½zie miaa sonda ? <input type="text" name="ile"> <br>
    <input type="submit" value="Dalej"></form>
    {/if}
    {if $Step=='add'}
    <form method="post" action="admin.php?view=poll&step=confirm">
...
{if $View == "zabij"}
    <form method="post" action="admin.php?view=zabije&step=zabijed">
    ID: <input type="text" name="id"> <br>
<input type="submit" value="Zabij"></form>
{/if}

{$Message}

{if $View != ""}
    <br />(<a href="admin.php">Wroc do menu</a>)
{/if}
