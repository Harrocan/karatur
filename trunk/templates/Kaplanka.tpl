{if $View == ""}
    Witaj w panelu Kaplanki. Co chcesz zrobic?
    <ul>
    <li><a href="Kaplanka.php?view=poczta">Wyslij poczte do wszystkich</a>
	<li><a href="Kaplanka.php?view=pary">Daj slub</a>
    </ul>
{/if}

{if $View == "pary"}
    <form method="post" action="Kaplanka.php?view=pary&step=add">
...
{if $View == "poczta"}
    <table>
    <form method="post" action="Kaplanka.php?view=poczta&step=send">
