...
{if $Temple == ""}
    Witaj w swiatyni Lathandera. Mozesz tutaj modlic sie do {$God}. Aby twoja modlitwa zostala wysluchana, musisz posiadac odpowiednia
    ilosc Punktow Wiary. Punkty zdobywasz sluzac w swiatyni. To czym ciebie obdaruje bog zalezy tylko od niego.<br><br>
    <ul>
    <li><a href="lathandertemple.php?temp=sluzba">Pracuj dla swiatyni</a></li>
    <li><a href="lathandertemple.php?temp=modlitwa">Modl sie do {$God}</a></li>
    </ul>
{/if}
...
{if $Temple == "sluzba"}
    ...
    <form method="post" action="lathandertemple.php?temp=sluzba&dalej=tak">
...
{if $Temple == "modlitwa"}
    ...
    <ul>
    <li><a href="lathandertemple.php?temp=modlitwa&modl=tak">Tak</a></li>
    <li><a href="lathandertemple.php">Nie</a></li></ul>
{/if}
