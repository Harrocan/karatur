...
<table border="0" width="390px">
	<tr>
		<td><br/><br/>
			Wchodzisz do czarnej jak noc piwnicy. Jedyne zrodlo swiatla to jasniejaca twarz karczmarza. Tutaj stawiamy na klimat, nic innego sie nie liczy...
			<br/><br/>
			<center>
				|| <a href="bezklimy.php">Pokoj Nieklimatyczny</a> (<span id="roomOffAmount">0</span>) 
