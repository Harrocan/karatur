...
{if $Temple == ""}
    ...
    <ul>
    <li><a href="tyrtemple.php?temp=sluzba">Pracuj dla swiatyni</a></li>
    <li><a href="tyrtemple.php?temp=modlitwa">Modl sie do {$God}</a></li>
    </ul>
{/if}
...
{if $Temple == "sluzba"}
    ...
    <form method="post" action="tyrtemple.php?temp=sluzba&dalej=tak">
...
{if $Temple == "modlitwa"}
    ...
    <ul>
    <li><a href="tyrtemple.php?temp=modlitwa&modl=tak">Tak</a></li>
    <li><a href="tyrtemple.php">Nie</a></li></ul>
{/if}
