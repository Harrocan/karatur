...
$chat = $db -> SelectLimit("SELECT * FROM tyrkosciol WHERE ownerid=0 OR ownerid=".$stat -> fields['id']." OR senderid=".$stat -> fields['id']." ORDER BY id DESC", 15) or die("blad!");
$pl = $db -> Execute("SELECT rank, id, lpv, user FROM players WHERE page='Kosciol Tyra'");
$arrtext = array();
$arrauthor = array();
$arrsenderid = array();
$i = 0;
...
$smarty -> display ('tyrkosciolsgs.tpl');
